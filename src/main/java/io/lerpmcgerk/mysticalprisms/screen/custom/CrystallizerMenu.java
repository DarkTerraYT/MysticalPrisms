...
public class CrystallizerMenu extends AbstractContainerMenu {
    ...
    public CrystallizerMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data)
    {
        ...
        this.addSlot(new FluidContainerSlot(blockEntity.itemHandler, 0, 9, 11));
        this.addSlot(new OutputItemSlot(blockEntity.itemHandler, 1, 9, 34));
        this.addSlot(new FluidContainerSlot(blockEntity.itemHandler, 2, 9, 57));
        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 3, 64, 34));
        this.addSlot(new OutputItemSlot(blockEntity.itemHandler, 4, 130, 34));
    ...
    public double getCraftingProgressPercent(int decimals)
    {
        ...
        int percentInt = maxProgress == 0 ? 100 : progress == 0 ? 0 : progress/maxProgress * 100;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CRYSTAL_GROWER.get());
    }
