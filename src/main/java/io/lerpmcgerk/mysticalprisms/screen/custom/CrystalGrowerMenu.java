...
public class CrystalGrowerMenu extends AbstractContainerMenu {

    public final CrystalGrowerBlockEntity blockEntity;
    ...
    {
        super(ModMenuTypes.CRYSTAL_GROWER_MENU.get(), containerId);
